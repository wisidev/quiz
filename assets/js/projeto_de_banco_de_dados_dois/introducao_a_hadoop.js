const introducao_a_hadoop = [
  ...
  },
  {
    ...
    opcoes: [
      ...
      "O DataNode localiza-se no nó mestre, identificando os dados que são distribuídos e replicados.",
      "O JobTracker é o responsável pelo trabalho de execução das tarefas do MapReduce, que são realizadas nos nós.",
      "O TaskTracker possui a tarefa de controlar o plano de execução do MapReduce, designando os nós que serão utilizados.",
